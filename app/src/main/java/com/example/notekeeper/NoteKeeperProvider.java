...
public class NoteKeeperProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(NoteKeeperProviderContract.AUTHORITY, Notes.PATH + "/#", COURSES_ROW);
        sUriMatcher.addURI(NoteKeeperProviderContract.AUTHORITY, Notes.PATH_EXPANDED + "/#",
                NOTES_EXPANDED_ROW);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch(uriMatch){
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.notekeeper.notekeeper.provider.courses
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatch){
            ...
            case NOTES_ROW:
                ...
                cursor = db.query(NoteInfoEntry.TABLE_NAME, projection, rowSelection, rowSelectionArgs, null,
                        null, null);
                break;
        }
        return cursor;
    ...
    private Cursor notesExpandedQuery(SQLiteDatabase db, String[] projection, String selection,
        ...
        for (int idx = 0; idx < projection.length; idx++){
            columns[idx] = projection[idx].equals(BaseColumns._ID)  || projection[idx].equals(CourseIdColumns.COLUMN_COURSE_ID) ?
